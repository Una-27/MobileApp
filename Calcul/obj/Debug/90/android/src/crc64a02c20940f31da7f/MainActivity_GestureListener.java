...
public class MainActivity_GestureListener
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Calcul.MainActivity+GestureListener, Calcul", MainActivity_GestureListener.class, __md_methods);
	}


	public MainActivity_GestureListener ()
	{
		super ();
		if (getClass () == MainActivity_GestureListener.class)
			mono.android.TypeManager.Activate ("Calcul.MainActivity+GestureListener, Calcul", "", this, new java.lang.Object[] {  });
	}
